...
CREATE TABLE Member (
    ...
    stationNumber INT references Station(stationId),
    isActive BOOL,
...
CREATE TABLE CertificationAssociation (
    ...
    overdue ENUM('Not Overdue', 'Expired','Enter Status') Not Null default 'Enter Status'
);
